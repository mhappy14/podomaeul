    ...
    <header><!--  style="background-color: #8523a1;" -->
      <div class="d-flex flex-wrap justify-content-center py-2 mb-2 border-bottom">
        ...
        <ul class="nav nav-pills gap-3">
          ...
          <li><a href="board.php" class="nav-link text-black-50 fs-6 <?= ($menu_code == 'board') ? 'fw-bold': ''; ?>">게시판</a></li>
...
?>
        ...
        <li class="nav-item"><a href="board.php" class="nav-link <?= ($menu_code == 'board') ? 'fw-bold': ''; ?>">게시판</a></li>
